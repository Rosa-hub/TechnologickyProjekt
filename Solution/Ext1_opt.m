function output=pokus_o_kompletnost_m_TP_dry(c_ferm,V_ferm,mBAinput,m_extrahovadlo)
clc
close all
...
Dc=fzero(@priemerKolony,Dcn,opt,Af,V_broth,m_org,ro_d,vis_c,ro_c,d32,g,d_ro,opt);

function f=priemerKolony(Dc,Af,V_broth,m_org,ro_d,vis_c,ro_c,d32,g,d_ro,opt)
    Vcn = V_broth/3600*4/pi/Dc^2;         % m/s  % rychlost prudenia kontinalnej fazy     
    Vdn = m_org/ro_d/3600*4/pi/Dc^2;
    
    
    xdn = (3.25e3+7.54e7*Af^3)*Vdn^0.81*(Vcn+Vdn)^0.32*d_ro^-0.98;    
