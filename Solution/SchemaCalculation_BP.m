...
Y1opt=[0.80 0.82 0.84 0.86 0.88 0.9 0.92 0.94 0.96 0.99];
Y2opt=[0.80 0.82 0.84 0.86 0.88 0.9 0.92 0.94 0.96 0.99];
...
if isempty(Y)==1
    ...
    [mSOL,Ext1]=bipolar1(100,1000,BA,Vext,Y,mBA_nastrel);
...
if isempty(Y)==1
    ...
    [mSOL,Ext2]=bipolar2(100,800,Y);
end

function [f,Ext1c]=bipolar1(mSOLa,mSOLb,BA,Vext,Y,mBA_in)
N=1;
tol=0.01;
Nmax=100;
a=mSOLa;
...
while N<Nmax
c=(a+b)/2;
Ext1a=Ext1_opt(BA,Vext,mBA_in,a);
Ext1c=Ext1_opt(BA,Vext,mBA_in,c);
fa=round(Ext1a.Y,1)-Y*100;
fc=round(Ext1c.Y,1)-Y*100;
...
function [f,Ext2c]=bipolar2(mSOLa,mSOLb,Y)
...
Ext2a=Ext2_opt(a);
Ext2c=Ext2_opt(c);
fa=round(Ext2a.Y,1)-Y*100;
fc=round(Ext2c.Y,1)-Y*100;
